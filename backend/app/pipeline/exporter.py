...
def _export_pdf(path: Path, text: str, original_filename: str, metadata: dict[str, Any]) -> None:
    ...
    if rows:
        ...
        for row in rows:
            table_data.append(
                [
                    Paragraph(_escape_pdf_text(_compact_cell(_row_value(row, "original_value"))), meta_style),
                    Paragraph(_escape_pdf_text(_compact_cell(_row_value(row, "entity_type"), 60)), meta_style),
                    Paragraph(_escape_pdf_text(_compact_cell(_row_value(row, "anonymous_id"), 60)), meta_style),
                    str(_row_value(row, "occurrences")),
                ]
            )
